...
# Select a model from ['RC', 'PRC', 'HoGRC','NDCN','TPI']
model_ind = 'HoGRC'
...
def sav_er2(): 
    ...
    lens2,lens3 = experiment.VPT(error2s,error3s,steps,num)
    return(preds2s,preds3s,error2s,error3s)
...
experiment.draw_3d(preds,preds2s[st],preds3s[st],start2s[st],start3s[st],steps,nj)
